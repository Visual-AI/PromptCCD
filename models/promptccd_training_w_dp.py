...
from models.dp_utils.vision_transformer import vit_base_patch16_224_dino
...
class PromptCCD_Model:
    def __init__(self, args, model, stage_i):
        ...
        if model == None:
            self.model, self.original_model, self.projection_head = get_vit_model(args, self.stage_i)
        else:
